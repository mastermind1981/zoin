...
INSERT INTO `Hero` (`id`, `firstName`, `lastName`, `picturePath`, `role`, `skillSet_id`, `educationTarget`) VALUES ('102', 'Thomas', 'Hederer', 'img/Head1.png', 'SeniorSoftwareEngineer', '102', 'UITesting');
...
INSERT INTO `Hero` (`id`, `firstName`, `lastName`, `picturePath`, `role`, `skillSet_id`, `educationTarget`) VALUES ('103', 'Alexandro', 'Wermer', 'img/Head7.png', 'SeniorSoftwareEngineer', '103', 'UITesting');
